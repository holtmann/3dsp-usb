...
//Jakio20080104: driver state for supporting combo
#define START_STAGE_INIT			0x01		//init not complete
#define START_STAGE_MINLOOP		0x02		//all resources are allocated, but can not interact with device
#define START_STAGE_MAINLOOP		0x03		//all resources are allocateed, and can interact with device

//Jakio20080811: change defined values
//Jakio20080804: driver state for WB application
#define BTUSB_STATE_NORMAL        1
#define BTUSB_STATE_SWITCHING    0
#define BTUSB_STATE_UNLOAD        2


//#define START_MODE_FULL_STAGE			(START_MODE_FIRST_STAGE | START_MODE_SECOND_STAGE)
//#define MASK_START_MODE_FIRST			0xfe
//#define MASK_START_MODE_SECOND		0xfd



#define FW_WORK_MODE_SINGLE		0x00
#define FW_WORK_MODE_COMBO		0x01


#define PIPE_NUMBER_READ_PIPE			0x00	
#define PIPE_NUMBER_ACL_PIPE			0x01
#define PIPE_NUMBER_INQUIRY_PIPE		0x02			
#define PIPE_NUMBER_SCO_PIPE			0x03
#define PIPE_NUMBER_INT_PIPE			0x04			
			



//#define START_STAGE_INIT			0x00
//#define START_STAGE_LIMITED			0x01
//#define START_STAGE_FULL			0x02
    ...
    //    unsigned char    da[0x200 - sizeof(MAC_STRUC1)];
    //} DUMMYa_STRUC;
    //
    //typedef struct _DUMMYb {
    //    unsigned char    db[0x200 - sizeof(MAC_STRUC2)];
    //} DUMMYb_STRUC;
    //
    //typedef struct _DUMMYc {
    //    unsigned char    db[0x400 - sizeof(MAC_STRUC3)];
    //} DUMMYc_STRUC;
    //
    //typedef struct _DUMMYd {
    //    unsigned char    db[0x3800 - sizeof(MAC_STRUC4)];
    //} DUMMYd_STRUC;
    //
    ...
    //    unsigned char    d[0x2000 - sizeof(WLSCSR_STRUC)];
    //} DUMMY1_STRUC;
    //
    //#define SCRATCHRAM_SIZE     0x1000
    //typedef struct _SCRATCH {
    //    unsigned char    scratchram[SCRATCHRAM_SIZE];
    //} SCRATCH_STRUC;
    //
    //typedef struct _DUMMY1_5 {
    //    unsigned char  d1_5[(sizeof(SCRATCH_STRUC) + sizeof(DUMMY1_STRUC) + sizeof(WLSCSR_STRUC))];
    //} DUMMY1_5_STRUC;
    //
    //typedef struct _DUMMY2 {
    //    unsigned char  d2[0x4000 - (sizeof(DUMMY1_5_STRUC))];
    //} DUMMY2_STRUC;
    //
    //
    ...
    //
    //
    //static_axLookupFreqByChannel_BOnly[] =
...
#define MAC_BBREG_ACCESSS(Enable, Direction, Data, BBRegNum) \
    ...
    #define STRACTH__OFFSET_PAD					(_OFFSET_SPD + 0x0C00)

    #define WLS_STRACTH__BASEBAND_VER	    	(STRACTH__OFFSET_PAD + 0x0000)	//Baseband version number
    #define WLS_STRACTH__SP20_READY    			(STRACTH__OFFSET_PAD + 0x0004)	//SP-20 Ready
    #define WLS_STRACTH__RX_OVERFLOW	    	(STRACTH__OFFSET_PAD + 0x0008)	//RxBufOverflowFlag
    #define WLS_STRACTH__CTS_PREAMBLE	    	(STRACTH__OFFSET_PAD + 0x000C)	//CTSPreambleType_Bitrate

    #define WLS_STRACTH__RX_C_PTR    			(STRACTH__OFFSET_PAD + 0x0010)	//rx consumer pointer
    #define WLS_STRACTH__TX_PRIORITY_PTR    	(STRACTH__OFFSET_PAD + 0x0014)	//tx producer pointer for Priority FIFO
    #define WLS_STRACTH__TX_CFP_PTR   	 		(STRACTH__OFFSET_PAD + 0x0018)	//tx producer pointer for Contention Free Period FIFO
    #define WLS_STRACTH__TX_CP_PTR   	 		(STRACTH__OFFSET_PAD + 0x001C)	//tx producer pointer for Contention Period FIFO


    #define WLS_STRACTH__TX_BCN_PPTR    		(STRACTH__OFFSET_PAD + 0x0020)	//TxBeaconPptr
    #define WLS_STRACTH__RX_BUF_SEG_PPTR    	(STRACTH__OFFSET_PAD + 0x0024)	//RxBufSegNextToInitialPptr
    #define WLS_STRACTH__RX_BUF_INIT_PPTR  	 	(STRACTH__OFFSET_PAD + 0x0028)	//RxBufInitialPptr
    #define WLS_STRACTH__RX_BUF_SEG  	 		(STRACTH__OFFSET_PAD + 0x002C)	//RxBufSegs(0 < RxBufSegs <= 0x10)


    #define WLS_STRACTH__RX_SEG_BD    			(STRACTH__OFFSET_PAD + 0x0030)	//RxSegBD[0]
     ...
     *
     */
    #define WLS_STRACTH__TXPOWER_TABLE			(_OFFSET_SPD + 0xFD8)				//txpower table
    ...
    #define STRACTH_BASE_ADDR 		   		0x00002000
    #define STRACTH_PAD_ADDR 	   	      	0x00000C00
    #define STRACTH_BASEBAND_VERSION    	0x00000000
    #define STRACTH_SP20_READY 		   		0x00000004
    #define STRACTH_RX_OVERFLOW		   		0x00000008
    #define STRACTH_CTS_PREAMBLE    		0x0000000C




    #define STRACTH_CTS_FCS_TABLE   		0x00000400
...
//Jakio20071010: add for v4 chip
    ...
    //#define OFFSET_VENDER_CMD_REG				0x108            //vender cmd register
    //#define OFFSET_8051_RESET_FW_REG			0x100		//define it later

    //#define VENDOR_CMD_LENGTH_BYTES			1
